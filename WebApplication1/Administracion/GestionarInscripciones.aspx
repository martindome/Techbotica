...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="container">
        ...
        <asp:GridView ID="UsersGrid" runat="server" CssClass="table-responsive" AutoGenerateColumns="false" DataKeyNames="IdUsuario">
            <Columns>
        ...
        <asp:GridView ID="UserCoursesGrid" runat="server"  CssClass="table-responsive" AutoGenerateColumns="false" DataKeyNames="IdInscripcion" >
            <Columns>
                <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
        ...
        <asp:GridView ID="UserCareersGrid" runat="server" CssClass="table-responsive" AutoGenerateColumns="false" DataKeyNames="IdInscripcion">
            <Columns>
                <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
                <asp:BoundField DataField="FechaInscripcion" HeaderText="Fecha de Inscripción" DataFormatString="{0:d}" HtmlEncode="false" />
                <asp:TemplateField>
